...
NAME = vox
SRCS = srcs/NewMesh.cpp srcs/Renderer.cpp srcs/Block.cpp srcs/Chunk.cpp srcs/ComputeShader.cpp srcs/BSphere.cpp srcs/Button.cpp srcs/Font.cpp srcs/Animation.cpp srcs/MatrixStack.cpp srcs/main.cpp srcs/Shader.cpp srcs/Vector2.cpp srcs/Vector3.cpp srcs/stb.cpp srcs/Vector4.cpp srcs/Matrix4.cpp srcs/Mesh.cpp srcs/ScopMaths.cpp srcs/Camera.cpp srcs/Object.cpp
